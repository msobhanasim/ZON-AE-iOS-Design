...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "${PODS_ROOT}/LiveChat/Sources/LiveChatWidget.js"
  install_resource "${PODS_CONFIGURATION_BUILD_DIR}/NISdk/NISdk.bundle"
  install_resource "${PODS_ROOT}/Sizes/Sizes/Classes/ViewControllers/ConfigurationViewController.xib"
fi
